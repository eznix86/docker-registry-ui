...
const VersionBadge = styled(Box)<{ hasUpdate: boolean }>(({ theme, hasUpdate }) => ({
	position: "fixed",
	right: theme.spacing(2),
	bottom: theme.spacing(2),
	padding: theme.spacing(1, 2),
	backgroundColor: alpha(theme.custom.colors.background.paper, hasUpdate ? 0.9 : 0.4),
...
function Footer() {
	const { currentVersion, latestVersion, hasNewVersion, releaseUrl, isLoading } =
		useVersion();
