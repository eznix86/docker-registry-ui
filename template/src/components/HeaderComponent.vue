	...
	<header class="bg-gradient-to-r from-primary to-accent flex items-center justify-between shadow-md h-16">
		<div class="flex items-center flex-1 md:pl-6 pl-4">
			...
			<button
				...
				title="Go to home"
			>
				<img src="/container-hub.svg" alt="ContainerHub" class="w-6 h-6" style="filter: brightness(0) invert(1);">
			</button>
...
// Use Pinia store for search query
...
watch(() => filterStore.searchQuery, (newQuery) => {
