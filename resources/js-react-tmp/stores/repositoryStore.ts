...
function performFilterRequest(state: RepositoryState) {
...
// Selector hooks
export function useLocalSortBy() {
	return useRepositoryStore(state => state.localSortBy)
}
export function useLocalFilter() {
	return useRepositoryStore(state => state.localFilter)
}
export function useSetSortBy() {
	return useRepositoryStore(state => state.setSortBy)
}
export function useSetFilter() {
	return useRepositoryStore(state => state.setFilter)
}
