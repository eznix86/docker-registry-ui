...
export function range(start: number, end: number = start, step = 1) {
	const output = []
...
export function getDisplayName(repo: Repository) {
...
export function pullCommand(repo: Repository, tag: string) {
