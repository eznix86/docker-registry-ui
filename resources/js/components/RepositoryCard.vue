...
const emit = defineEmits<{ showUntagged: [repo: Repository] }>()
...
function getRepositoryUrl(): string {
	...
	if (!registryHost || registryHost.trim() === "") {
		console.error(`Repository "${name}" has empty registryHost:`, props.repository)
		return "#"
	}
	return repositoryPath(props.repository)
}
</script>
